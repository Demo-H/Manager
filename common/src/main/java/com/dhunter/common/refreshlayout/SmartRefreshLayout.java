package com.dhunter.common.refreshlayout;
...
import com.dhunter.common.refreshlayout.api.DefaultRefreshFooterCreator;
import com.dhunter.common.refreshlayout.api.DefaultRefreshHeaderCreator;
import com.dhunter.common.refreshlayout.api.DefaultRefreshInitializer;
import com.dhunter.common.refreshlayout.api.RefreshContent;
import com.dhunter.common.refreshlayout.api.RefreshFooter;
import com.dhunter.common.refreshlayout.api.RefreshHeader;
import com.dhunter.common.refreshlayout.api.RefreshInternal;
import com.dhunter.common.refreshlayout.api.RefreshKernel;
import com.dhunter.common.refreshlayout.api.RefreshLayout;
import com.dhunter.common.refreshlayout.api.ScrollBoundaryDecider;
import com.dhunter.common.refreshlayout.constant.DimensionStatus;
import com.dhunter.common.refreshlayout.constant.RefreshState;
import com.dhunter.common.refreshlayout.constant.SpinnerStyle;
import com.dhunter.common.refreshlayout.footer.BallPulseFooter;
import com.dhunter.common.refreshlayout.header.BezierRadarHeader;
import com.dhunter.common.refreshlayout.impl.RefreshContentWrapper;
import com.dhunter.common.refreshlayout.impl.RefreshFooterWrapper;
import com.dhunter.common.refreshlayout.impl.RefreshHeaderWrapper;
import com.dhunter.common.refreshlayout.listener.OnLoadMoreListener;
import com.dhunter.common.refreshlayout.listener.OnMultiPurposeListener;
import com.dhunter.common.refreshlayout.listener.OnRefreshListener;
import com.dhunter.common.refreshlayout.listener.OnRefreshLoadMoreListener;
import com.dhunter.common.refreshlayout.listener.OnStateChangedListener;
import com.dhunter.common.refreshlayout.util.DelayedRunnable;
import com.dhunter.common.refreshlayout.util.DensityUtil;
import com.dhunter.common.refreshlayout.util.SmartUtil;
import com.dhunter.common.refreshlayout.util.ViscousFluidInterpolator;
                ...
                if (!mIsBeingDragged && mDragDirection != 'h' && mRefreshContent != null) {//没有拖动之前，检测  canRefresh canLoadMore 来开启拖动
                    if (mDragDirection == 'v' || (Math.abs(dy) >= mTouchSlop && Math.abs(dx) < Math.abs(dy))) {//滑动允许最大角度为45度
                        ...
                        if (mIsBeingDragged) {
                            ...
                            if (parent != null) {
                                //修复问题 https://github.com/https://github.com/scwang90/SmartRefreshLayout90/SmartRefreshLayout/issues/580
...
//    }
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link .listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
