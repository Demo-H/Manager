...
/**
 * Created by dhunter on 2018/10/18.
 */

public class PageContainer extends CoordinatorLayout implements PageNestedScrollView.OnScrollListener {
    private PageNestedScrollView child;
    ...
    public void onViewAdded(View child) {
        ...
        if (child instanceof PageNestedScrollView) {
            this.child = ((PageNestedScrollView) child);
            this.child.setScrollListener(this);
        }

        CoordinatorLayout.LayoutParams layoutParams = (LayoutParams) child.getLayoutParams();
