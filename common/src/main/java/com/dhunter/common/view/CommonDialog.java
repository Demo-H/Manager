...
import com.dhunter.common.base.BaseDialog;
...
public class CommonDialog extends BaseDialog {
    ...
    protected void initUI() {
        switch (type) {
            ...
            case DIALOG_DISPLAY_ADVERTISING:
                builder.setTitle(title);
                ImageView iv_advertising = (ImageView)mainView.findViewById(R.id.iv_advertising);
                iv_advertising.setImageResource(R.mipmap.icon_progress_bar_loading);
