...
//    private static final int TAG_KEY_HAVE_SET_OFFSET = -123;
    ...
    public static void setTranslucentForImageView(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha,
        ...
        if (needOffsetView != null) {
            Object haveSetOffset = needOffsetView.getTag(R.id.TAG_KEY_HAVE_SET_OFFSET);
    ...
    public static void setStatusBarTextColor(Activity activity,boolean isDark) {
        ...
        if (FlymeUtils.isFlyme2()) {
            StatusBarUtils.FlymeSetStatusBarLightMode(activity.getWindow(), isDark);
        }

        if (MIUIUtils.isMIUI()) {
            StatusBarUtils.MIUISetStatusBarLightMode(activity.getWindow(), isDark);
        }
    }
}
